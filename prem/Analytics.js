...
import { api, getSpendingAnalytics, getSpendingInsights } from '../services/api';
          ...
          <Card>
            <CardContent>
              ...
              >
                ...
                {analytics?.totalChange?.toFixed(1) || '0.0'}% vs previous period
              </Typography>
            </CardContent>
          </Card>
        </Grid>
        ...
        <Grid item xs={12} md={4}>
          <Card>
            <CardContent>
              ...
              <Typography variant="h4">
                ${analytics?.monthlyAverage?.toFixed(2) || '0.00'}
              </Typography>
            </CardContent>
          </Card>
        </Grid>
                ...
                {analytics?.topCategories?.map((category, index) => (
                  <ListItem key={index}>
                    <ListItemText
                      ...
                      secondary={`$${category.currentTotal?.toFixed(2) || '0.00'} (${category.change?.toFixed(1) || '0.0'}%)`}
                    />
                  </ListItem>
                ))}
              </List>
